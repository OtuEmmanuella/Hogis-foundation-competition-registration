...
const formSchema = z.object({
  ...
  // If age is less than 18, parentName and parentPhone are required
  if (data.age < 18) {
...
const RegistrationForm = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    alert('Form is being submitted!'); // Temporary debug alert
    ...
    try {
      ...
      console.log('Passport photo file:', passportPhoto);
      
      // Upload photo
      const photoRef = ref(storage, `passport-photos/${Date.now()}-${passportPhoto.name}`);
      console.log('Photo ref created:', photoRef);
      
      await uploadBytes(photoRef, passportPhoto);
      console.log('Photo bytes uploaded');
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <Button
                  ...
                  className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 text-sm mb-4"
                >
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold py-6 text-lg shadow-lg cursor-pointer"
                >
                  {isSubmitting ? (
                    <>
